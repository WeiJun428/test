...
public:
    ...
    void Compute(OpKernelContext* context) override {
        ...
        int grid_dim_w = (int)ceil(dimension[0] / resolution[0]) + 1;
        int grid_dim_l = (int)ceil(dimension[1] / resolution[1]) + 1;
        int grid_dim_h = (int)ceil(dimension[2] / resolution[2]) + 1;
...
//
        if ((int)input_coors.dim_size(0) != (input_accu_list_ptr_host[batch_size-1] + input_num_list_ptr_host[batch_size-1])){
            printf("VoxelSamplingOp expects input_coors dim 0 to have same size as total number of points in input_num_list. [%d] not equal [%d] \n",
        ...
        if (center_num != (center_accu_list_ptr_host[batch_size-1] + center_num_list_ptr_host[batch_size-1])){
            printf("VoxelSamplingOp expects center_coors dim 0 to have same size as total number of points in center_num_list. [%d] not equal [%d] \n",
